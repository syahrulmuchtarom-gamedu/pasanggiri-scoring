      ...
      <div className="card">
        ...
        {activeCompetitions.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-gray-500">Tidak ada pertandingan aktif saat ini</p>
            <p className="text-sm text-gray-400 mt-2">Tunggu SIRKULATOR mengaktifkan sesi pertandingan</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {activeCompetitions.map(competition => (
              <div key={competition.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                <div className="mb-3">
                  <h3 className="font-medium">{competition.desa}</h3>
                ...
                <div className="mb-3">
                  ...
                  <div className="space-y-1">
                    {SCORING_CRITERIA[competition.kategori].map(criteria => (
                      <div key={criteria.name} className="text-xs text-gray-600">
